...
export default function TimelineSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center bg-[url('/images/svgs/time.svg')] bg-cover bg-center py-8 sm:py-12 px-4 w-full min-h-[708px] overflow-hidden border-t-2 border-violet-700 ">
      {/* Title */}
      <motion.h2
      ...
      >
        A timeline of how Yuvabe evolved from a youth-focused initiative into a
        multidisciplinary creative and technology studio
      </motion.p>
          ...
          activeIndex === index
            ...
            : "bg-gray-400 hover:shadow-[0_0_10px_2px_rgba(255,202,45,0.4)]"
              ...
              style={{
                ...
                left: data.dotPosition[
                  windowWidth <= 640 ? "mobileLeft" : "left"
                ],
              }}
